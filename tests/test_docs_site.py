...
class DocsSiteTests(unittest.TestCase):
    def test_build_docs_site_writes_dense_browser_pages(self) -> None:
        ...
        self.assertIn("restaurant plus airline can become prompt-dev", index_html)
        ...
        self.assertIn("deterministic SQLite profile notes", research_html)
        self.assertIn("prompt-dev gains", research_html)
