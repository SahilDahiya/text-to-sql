    ...
    body = f"""
        ...
        <section class="panel full">
          ...
          <table class="key-table">
            ...
            <tr><th>TAP-643</th><td><code>sql_adapter_dev_endpoint_monitoring:v1</code> records endpoint quality and runtime signals: request count, concurrency, success/error/timeout counts, p50/p95/p99 latency, generated SQL character-count min/p50/p95/max/mean, endpoint pass rate, empty SQL count, and SQL failure buckets. Token counts are not claimed unless the serving artifact records them.</td></tr>
